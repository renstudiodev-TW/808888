...
const FAQ: { q: string; a: string }[] = [
  {
    q: "808888.tw 是什麼？",
    a: "808888.tw 是用 AI 統計把台灣樂透（今彩539、大樂透、威力彩）的民間抓牌技巧自動化的分析網站，提供冷熱號、遺漏值、尾數、區間、拖牌、和值走勢等指標與每日精選參考。僅供參考娛樂，無法提高中獎率、不保證中獎。",
  },
  {
    q: "冷熱號是怎麼判斷的？",
  ...
  {
    q: "精選跟分析是免費的嗎？",
    a: "冷熱、遺漏、尾數、區間、和值走勢等完整統計與每日中評分參考號免費看；AI 高評分精選號、拖牌版路、每日 LINE 精選推播等進階功能為付費訂閱。",
  },
];
